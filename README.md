...
[![Go Report Card](https://goreportcard.com/badge/github.com/onedss/rxgo)](https://goreportcard.com/report/github.com/onedss/rxgo)

Reactive Extensions for the Go Language

**Important**: This version is deprecated, please upgrade to v2 (`github.com/onedss/rxgo/v2` module).
...
```bash
go get -u github.com/onedss/rxgo
```
